...
naively believe that an incident may never happen to them. %reference
                                %for that - JJ
 Actually, the employees' web misuse is one of the main causes of
 security breaches, %reference for that - JJ
 ...
 performed inside the security system. % references!!!! - JJ
...
current work. % in the current work or in general? References!!!! - JJ
...
defined by the Chief Security Officer (CSO) in the company. % if you
                                % have used this before, mention the
                                % paper, the previous  one if possible - JJ
...
a proper pre-processing of the data, reaching between 95\% and 97\% of
% no spoiler!!! Leave that for the conclusion. Just say that you want
% to improve accuracies obtained before - JJ
correctly classified patterns. Indeed, among the obtained results, we
demonstrated that it is possible to obtain useful rules, which are not
based only on the URL string, for classifying new unknown URLs as
allowed or as denied. 
