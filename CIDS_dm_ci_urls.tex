...
as a step beyond the use of self-updating % self updating? - JJ
...
%Some comment on the outcome. Does the proposed methodology work? - JJ
\end{abstract}
...
naively believe that an incident may never happen to them. %reference
                                %for that - JJ
 Actually, the employees' Internet misuse is one of the main causes of
