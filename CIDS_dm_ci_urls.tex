...
improvements made by means of an initial data pre-processing  
...
high accuracies can be obtained with a proper pre-processing of the
data, reaching between 96\% and 97\% of correctly classified
patterns. %while before we only obtained... - JJ
We also demonstrate that including the use of Computational Intelligence techniques, such as the one used for feature selection, enhances the system performance, while the accuracies maintain their values.
...
file. We realized % remarquer in French is "realize" in English - Jj
...
\centering
 \caption{\label{tabdata} Independent Variables corresponding to a URL
   ...
   Subsection \ref{subsec:logparsing}.} % This subsection does not
                                % exist - JJ
{\scriptsize
\begin{tabular}{llll}
\hline\noalign{\smallskip}
...
% You should probably divide this table in two, it's too wide - JJ
{\small
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  CONCLUSIONS  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\section{\uppercase{Conclusions and Future Work}} %why uppercase? - jj
