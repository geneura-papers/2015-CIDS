...
These files have been built considering that similar patterns of the whole dataset, are placed in the same file, in order to avoid biasing the classification.
