...
file. We realised
 ...
 to maintain the input file %maintain? keep? Maintain it how? - JJ
 by eliminating the redundant
 strings. The quality of the dataset is very important to
 generate accurate results and to have the possibility to learn models
 from the presented data. % repeated from previous paragraph, maybe
                          % eliminate  JJ
 Thus, maintaining it is an essential
 step. % maintaining quality?  Maintaining with respect to what?
       % Please rephrase
...
maintained % cleaned? preserved? cleansed? debugged? - JJ
...
Data reduction % data or feature reduction? - JJ
is a main point of interest across a wide
variety of fields and focusing on this step is crucial as it
often presents a source of significant data loss. % what? Reducing
                                % data means data loss? - JJ
Many techniques were
proposed in literature to achieve the task of data reduction %without
                                %data loss? - JJ
 and they
